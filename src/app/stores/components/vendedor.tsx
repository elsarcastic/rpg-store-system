...
export function Vendedor({ imgSrc, nome, link }: vendedorProps) {
    ...
    return (
        <div
            ...
            className='flex flex-1 flex-col items-center gap-4 cursor-pointer h-[420px] bg-yellow-950 p-4 rounded-lg justify-between hover:scale-110 hover:transition-all'>
